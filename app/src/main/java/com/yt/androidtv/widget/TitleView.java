...
import com.yt.androidtv.utils.DateUtil;
...
public class TitleView extends RelativeLayout {
	...
	public void initTitleView() {
		view = LayoutInflater.from(context).inflate(R.layout.title_view,
				this, true);
		layout = (RelativeLayout) view.findViewById(R.id.title_view_home);
		tvTime = (TextView) view.findViewById(R.id.title_view_time_hour);
		tvDate = (TextView) view.findViewById(R.id.title_view_date);
		imgNetWorkState = (ImageView) view.findViewById(R.id.title_view_networkstate);
...
//		imgNetWorkState = (ImageView) this.findViewById(R.id.home_networkstate);
	...
	private Runnable timeRun = new Runnable() {
		...
		public void run() {
			setTvTimeText(DateUtil.getTime());
			setTvDateDate(DateUtil.getDate());
